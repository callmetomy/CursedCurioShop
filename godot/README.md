...
The shop HUD shows Day, Cash, and Reputation from the shared `GameState` autoload. `Next Day` advances the run until the four-day prototype loop completes.
...
The latest local export was refreshed after the four-day `oddity_0004` playable schedule pass on 2026-05-25.
