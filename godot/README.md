...
The shop HUD shows Day, Cash, and Reputation from the shared `GameState` autoload. `Next Day` advances the run until the eight-day prototype loop completes.
...
The latest local export was refreshed after the eight-day `oddity_0008` playable schedule pass on 2026-05-25.
