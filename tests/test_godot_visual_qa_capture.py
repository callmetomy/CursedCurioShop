...
class GodotVisualQACaptureTests(unittest.TestCase):
    def test_capture_script_records_traditional_chinese_review_states(self):
        ...
        self.assertIn('_capture_late_wrong_outcome', script)
        ...
        self.assertIn('late_wrong_outcome', script)
        self.assertIn('game_state.set("current_day", 8)', script)
        self.assertIn('table.call("_resolve_decision", "sell")', script)
