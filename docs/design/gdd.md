...
The current playable demo is a nine-day slice:
...
All ten MVP oddities currently have Godot item scenes generated from structured data and processed local model assets. The nine-day playable loop currently presents `oddity_0001`, `oddity_0002`, `oddity_0003`, `oddity_0004`, `oddity_0005`, `oddity_0006`, `oddity_0007`, `oddity_0008`, and `oddity_0009` as the daily queue. The remaining oddities are ready content reserves for future queue expansion, balance passes, and visual polish.
...
- Advances through a nine-day loop.
