...
The current playable demo is a ten-day slice:
...
All ten MVP oddities currently have Godot item scenes generated from structured data and processed local model assets. The ten-day playable loop presents `oddity_0001`, `oddity_0002`, `oddity_0003`, `oddity_0004`, `oddity_0005`, `oddity_0006`, `oddity_0007`, `oddity_0008`, `oddity_0009`, and `oddity_0010` as the daily queue. Further content expansion should now come from new oddity batches, balance passes, and visual polish.
...
- Advances through a ten-day loop.
